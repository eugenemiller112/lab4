...
ggplot(subset(babies, Premature != "NA" & smoke != "NA")) + 
  ...
  facet_wrap(Premature~smoke, labeller = labeller(smoke = smoke.labs, Premature = prem.labs)) + 
  theme(text = element_text(hjust = 0.5, size = 9.5), plot.title = element_text(hjust = 0.5, size = 9.5)) +
  labs(x = "Number of Mother's Previous Pregn
       ancies", y = "Proportion of Babies Born", title = "Comparison of Previous Pregnancies Across Pregnancy Period and Mother's Smoking Status") +
  scale_fill_brewer(palette = 3)
>>>>>>> master
```
...
__Kaiyuan Fan__: For my individual part, I make a plot shows the number of people who is premature or full term in different weight of birth. We can find from the plot, the weight of people who is full term is mostly between 80 to 125. However, the weight of people who is premature is mostly between 95 to 150. Hence, we can conclude that premature will influence birth weight, and premature people will have less weight than people who have full term to born. Also, I create plot answering question 1.
